...
const PostRequestForExercise = (data) =>{
 ...
 object.excercise_done.push(data)
  ...
  return axios.post("https://calofit-backend-deployment.onrender.com/nutrition/add",object,
  {
    headers:{
      Authorization: `Bearer ${Token}`,
    }
...
object.excercise_done.push(data)
 ...
 axios.patch('https://calofit-backend-deployment.onrender.com/nutrition/update',object, 
  {
