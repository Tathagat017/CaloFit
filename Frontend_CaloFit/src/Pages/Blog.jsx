                ...
                >
                    <VStack w={["90%", "85%%", "45%"]}>
                        ...
                        <Text>
                            ...
                            CaloFit app lets you easily track your nutrition, helping you
                ...
                >
                    <Box w={["60%", "60%", "40%"]}>
                        ...
                        <Text color="white" fontSize={["m", "l", "xl"]} fontWeight="medium">
                            Track your foods, exercise, and health data with the CaloFit
                            app.
                        </Text>
                    </Box>
                ...
                >
                    <Flex w="46%" flexDirection={"column"} justifyContent="center">
                        <Text fontSize={["xl", "2xl", "3xl"]} fontWeight="bold">
                            Track your food, exercise and health metrics with the CaloFit
                            app.
                        </Text>
                        <br />
                        <Button
