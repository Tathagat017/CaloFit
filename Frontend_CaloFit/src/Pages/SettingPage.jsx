...
function AccountSettings() {
  return (
    <div className="midBody">
      <h2 className="heading">Account Settings <QuestionOutlineIcon /></h2>
      <div className="firstCart">
        <h3>Login</h3>
        <form action="">
          <p className="lableOfinput">Name</p>
          <input type="text" name="" id="" /> <button className="btn">UPDATE</button>
          <p className="lableOfinput">Email</p>
          <input type="text" name="" id="" /> <button className="btn">UPDATE</button>
          <p className="lableOfinput">Password</p>
          <input type="text" name="" id="" /> <button className="btn">UPDATE</button>
          <div className="twofactor">
            <p className="FORBOLD">Two-Factor Authentication <QuestionOutlineIcon /></p> 
          </div>
          <p className="poftext">Cronometer Supports Two-Factor Authentication with the Google Authenticator app. If you would like to enable two factor authentication on this account, please download this app from the app store.</p>
      ...
      <div className="firstCart second">
        ...
        <div className="twofactor">
          <p>Send me personalized in-app ads. (You will receive less relevant, non-personalized ads if you opt
            out)</p>
